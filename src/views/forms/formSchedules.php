...
<body>
  <div class="wrapper">
    ...
    <div id="content">
      ...
      <div class="mb-4">
        <h3 class="mb-4">Cadastro de horários</h3>
        <form>
          <div class="container text-start">
            <div class="row mb-4">
              <div class="col-4">
                <label for="exampleInputEmail1" class="form-label">Restaurantes</label>
                <div>
              ...
              <div class="col-4">
                <label for="exampleInputEmail1" class="form-label">Hora fim</label>
                <input type="text" class="form-control" name="end_time">
              </div>
              <div class="col-4">
                <label for="exampleInputEmail1" class="form-label">Dia da semana</label>
                <div>
                  <select class="form-select" aria-label="Default select example" name="week_day">
